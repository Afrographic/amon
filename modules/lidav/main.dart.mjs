...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _1363: x0 => ({sampleRate: x0}),
      _1364: x0 => new AudioContext(x0),
      _1365: (x0,x1) => x0.addModule(x1),
      _1367: (x0,x1,x2) => new AudioWorkletNode(x0,x1,x2),
      _1370: (x0,x1) => x0.connect(x1),
      _1372: x0 => x0.close(),
      ...
      _1441: (x0,x1,x2) => ({channelCount: x0,numberOfInputs: x1,numberOfOutputs: x2}),
      _1442: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._1442(f,arguments.length,x0) }),
      _1443: (x0,x1) => ({video: x0,audio: x1}),
      _1444: (x0,x1) => x0.createMediaStreamSource(x1),
