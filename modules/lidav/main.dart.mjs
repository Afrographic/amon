...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _1397: (x0,x1) => globalThis.jsFixWebmDuration(x0,x1),
      _1398: x0 => x0.createAnalyser(),
      _1399: (x0,x1) => x0.getFloatFrequencyData(x1),
      _1400: x0 => globalThis.MediaRecorder.isTypeSupported(x0),
      _1401: x0 => x0.decode(),
      ...
      _1412: x0 => x0.releaseMediaPlayer(),
      _1413: (x0,x1) => globalThis.newPlayerInstance(x0,x1),
      _1414: x0 => x0.initializeMediaPlayer(),
      _1418: (x0,x1,x2,x3,x4,x5,x6) => x0.startPlayer(x1,x2,x3,x4,x5,x6),
      _1419: x0 => x0.stopPlayer(),
      _1423: (x0,x1) => x0.seekToPlayer(x1),
      _1431: (module,f) => finalizeWrapper(f, function(x0,x1,x2) { return module.exports._1431(f,arguments.length,x0,x1,x2) }),
      ...
      _1434: (module,f) => finalizeWrapper(f, function(x0,x1) { return module.exports._1434(f,arguments.length,x0,x1) }),
      _1435: (module,f) => finalizeWrapper(f, function(x0,x1,x2,x3) { return module.exports._1435(f,arguments.length,x0,x1,x2,x3) }),
      ...
      _1440: (module,f) => finalizeWrapper(f, function(x0,x1,x2) { return module.exports._1440(f,arguments.length,x0,x1,x2) }),
      ...
      _1443: (x0,x1) => x0.appendChild(x1),
      _1444: (x0,x1) => x0.isEncoderSupported(x1),
      _1445: x0 => x0.releaseFlautoRecorder(),
      _1446: (x0,x1) => globalThis.newRecorderInstance(x0,x1),
      _1447: x0 => x0.initializeFlautoRecorder(),
      _1449: (x0,x1,x2,x3,x4,x5,x6,x7,x8,x9) => x0.startRecorder(x1,x2,x3,x4,x5,x6,x7,x8,x9),
      _1450: x0 => x0.stopRecorder(),
      ...
      _1459: (module,f) => finalizeWrapper(f, function(x0,x1,x2) { return module.exports._1459(f,arguments.length,x0,x1,x2) }),
      _1460: (module,f) => finalizeWrapper(f, function(x0,x1,x2,x3) { return module.exports._1460(f,arguments.length,x0,x1,x2,x3) }),
      _1461: (module,f) => finalizeWrapper(f, function(x0,x1,x2) { return module.exports._1461(f,arguments.length,x0,x1,x2) }),
      _1462: (module,f) => finalizeWrapper(f, function(x0,x1,x2) { return module.exports._1462(f,arguments.length,x0,x1,x2) }),
      _1463: (x0,x1) => x0.getItem(x1),
      _1464: (x0,x1) => x0.removeItem(x1),
      _1465: (x0,x1,x2) => x0.setItem(x1,x2),
      _1474: (x0,x1,x2) => ({channelCount: x0,numberOfInputs: x1,numberOfOutputs: x2}),
      _1475: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._1475(f,arguments.length,x0) }),
      _1476: (x0,x1) => ({video: x0,audio: x1}),
      _1477: (x0,x1) => x0.item(x1),
      _1478: () => new FileReader(),
      _1480: (x0,x1) => x0.readAsArrayBuffer(x1),
      _1481: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._1481(f,arguments.length,x0) }),
      _1482: (x0,x1,x2) => x0.removeEventListener(x1,x2),
      ...
      _1486: (x0,x1) => x0.removeChild(x1),
      _1550: () => new SpeechSynthesisUtterance(),
      _1551: x0 => x0.pause(),
      _1552: x0 => x0.resume(),
      ...
      _1559: (x0,x1) => x0.speak(x1),
      _1560: x0 => x0.cancel(),
      _1561: x0 => x0.getVoices(),
      _1563: Date.now,
      ...
      _1709: () => Symbol("jsBoxedDartObjectProperty"),
      _1710: x0 => x0.random(),
      ...
      _1810: x0 => new Blob(x0),
      _1811: (x0,x1,x2) => x0.open(x1,x2),
      _1812: (x0,x1) => new WebSocket(x0,x1),
      _1813: (x0,x1) => x0.getResponseHeader(x1),
      ...
      _1827: (x0,x1) => x0.key(x1),
      _1830: o => o instanceof Array,
      _1831: (a, i) => a.splice(i, 1)[0],
      _1834: a => a.pop(),
      _1835: (a, i) => a.splice(i, 1),
      _1836: (a, s) => a.join(s),
      ...
      _1846: (o, offsetInBytes, lengthInBytes) => {
      ...
      _1849: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1850: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Int8Array) return 1;
        return 2;
      },
      _1851: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1852: o => o instanceof Uint8ClampedArray,
      _1853: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1854: o => o instanceof Uint16Array,
      _1855: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      ...
      _1859: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1860: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Int32Array) return 1;
        return 2;
      },
      _1861: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1863: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1864: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Float32Array) return 1;
        return 2;
      },
      _1865: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1866: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Float64Array) return 1;
        return 2;
      },
      _1867: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1868: (a, i) => a.push(i),
      _1869: (t, s) => t.set(s),
      _1870: l => new DataView(new ArrayBuffer(l)),
      _1871: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1872: o => o.byteLength,
      _1873: o => o.buffer,
      _1874: o => o.byteOffset,
      _1875: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1876: (b, o) => new DataView(b, o),
      _1877: (b, o, l) => new DataView(b, o, l),
      _1878: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1879: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1880: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1881: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1882: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1883: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1884: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1885: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1886: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1887: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1888: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1889: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1892: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1893: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1894: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1895: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1896: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1897: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1898: Function.prototype.call.bind(Number.prototype.toString),
      _1899: Function.prototype.call.bind(BigInt.prototype.toString),
      _1900: Function.prototype.call.bind(Number.prototype.toString),
      _1901: (d, digits) => d.toFixed(digits),
      _1907: (x0,x1) => x0.getContext(x1),
      _1948: x0 => x0.readyState,
      _1950: (x0,x1) => { x0.timeout = x1 },
      _1951: x0 => x0.withCredentials,
      ...
      _1960: x0 => x0.responseText,
      _1971: x0 => x0.loaded,
      _1972: x0 => x0.total,
      _2019: (x0,x1) => { x0.draggable = x1 },
      _2035: x0 => x0.style,
      _2048: (x0,x1) => { x0.oncancel = x1 },
      _2054: (x0,x1) => { x0.onchange = x1 },
      _2094: (x0,x1) => { x0.onerror = x1 },
      _2250: (x0,x1) => { x0.href = x1 },
      _2394: (x0,x1) => { x0.download = x1 },
      _2419: (x0,x1) => { x0.href = x1 },
      _2467: (x0,x1) => { x0.src = x1 },
      _2478: x0 => x0.width,
      _2480: x0 => x0.height,
      _2637: x0 => x0.error,
      _2638: x0 => x0.src,
      _2639: (x0,x1) => { x0.src = x1 },
      _2647: (x0,x1) => { x0.preload = x1 },
      _2648: x0 => x0.buffered,
      _2651: x0 => x0.currentTime,
      _2652: (x0,x1) => { x0.currentTime = x1 },
      _2653: x0 => x0.duration,
      _2658: (x0,x1) => { x0.playbackRate = x1 },
      _2671: (x0,x1) => { x0.volume = x1 },
      _2688: x0 => x0.code,
      _2689: x0 => x0.message,
      _2763: x0 => x0.length,
      _2959: (x0,x1) => { x0.accept = x1 },
      _2973: x0 => x0.files,
      _2999: (x0,x1) => { x0.multiple = x1 },
      _3017: (x0,x1) => { x0.type = x1 },
      _3267: (x0,x1) => { x0.src = x1 },
      _3269: (x0,x1) => { x0.type = x1 },
      _3273: (x0,x1) => { x0.async = x1 },
      _3287: (x0,x1) => { x0.charset = x1 },
      _3312: (x0,x1) => { x0.width = x1 },
      _3314: (x0,x1) => { x0.height = x1 },
      _3735: () => globalThis.window,
      _3778: x0 => x0.location,
      _3797: x0 => x0.navigator,
      _4061: x0 => x0.localStorage,
      _4072: x0 => x0.protocol,
      _4076: x0 => x0.hostname,
      _4078: x0 => x0.port,
      _4165: x0 => x0.geolocation,
      _4168: x0 => x0.mediaDevices,
      _4170: x0 => x0.permissions,
      _4171: x0 => x0.maxTouchPoints,
      _4181: x0 => x0.platform,
      _4184: x0 => x0.userAgent,
      _4185: x0 => x0.vendor,
      _4188: x0 => x0.language,
      _4189: x0 => x0.languages,
      _4235: x0 => x0.data,
      _4272: (x0,x1) => { x0.onmessage = x1 },
      _4392: x0 => x0.length,
      _4609: x0 => x0.readyState,
      _4622: (x0,x1) => { x0.binaryType = x1 },
      _4625: x0 => x0.code,
      _4626: x0 => x0.reason,
      _5777: x0 => x0.destination,
      _5781: x0 => x0.state,
      _5782: x0 => x0.audioWorklet,
      _5885: (x0,x1) => { x0.fftSize = x1 },
      _5886: x0 => x0.frequencyBinCount,
      _5888: (x0,x1) => { x0.minDecibels = x1 },
      _5890: (x0,x1) => { x0.maxDecibels = x1 },
      _5892: (x0,x1) => { x0.smoothingTimeConstant = x1 },
      _6146: x0 => x0.port,
      _6285: x0 => x0.type,
      _6286: x0 => x0.target,
      _6326: x0 => x0.signal,
      _6338: x0 => x0.length,
      _6387: x0 => x0.firstChild,
      _6398: () => globalThis.document,
      _6479: x0 => x0.body,
      _6481: x0 => x0.head,
      _6809: x0 => x0.id,
      ...
      _8339: x0 => x0.type,
      _8345: x0 => x0.name,
      _8346: x0 => x0.lastModified,
      _8351: x0 => x0.length,
      _8356: x0 => x0.result,
      _8725: x0 => x0.mimeType,
      _8726: x0 => x0.state,
      _8730: (x0,x1) => { x0.onstop = x1 },
      _8732: (x0,x1) => { x0.ondataavailable = x1 },
      _8757: x0 => x0.data,
      _8847: x0 => x0.url,
      _8849: x0 => x0.status,
      _8851: x0 => x0.statusText,
      _8852: x0 => x0.headers,
      _8853: x0 => x0.body,
      _9240: x0 => x0.state,
      _9899: x0 => x0.sampleRate,
      _9911: x0 => x0.channelCount,
      _11251: (x0,x1) => { x0.display = x1 },
      _12473: x0 => x0.name,
      _13189: () => globalThis.console,
      _13212: () => globalThis.document,
      _13214: () => globalThis.console,
      _13219: (x0,x1) => { x0.height = x1 },
      _13221: (x0,x1) => { x0.width = x1 },
      _13223: (x0,x1) => { x0.pointerEvents = x1 },
      _13232: x0 => x0.style,
      _13235: x0 => x0.src,
      _13236: (x0,x1) => { x0.src = x1 },
      _13237: x0 => x0.naturalWidth,
      _13238: x0 => x0.naturalHeight,
      _13253: (x0,x1) => x0.error(x1),
      _13258: x0 => x0.status,
      _13259: (x0,x1) => { x0.responseType = x1 },
      _13261: x0 => x0.response,
      _13266: () => globalThis.speechSynthesis,
      _13267: (x0,x1) => { x0.lang = x1 },
      _13269: (x0,x1) => { x0.pitch = x1 },
      _13272: (x0,x1) => { x0.rate = x1 },
      _13274: (x0,x1) => { x0.text = x1 },
      _13275: (x0,x1) => { x0.voice = x1 },
      _13276: x0 => x0.voice,
      _13278: (x0,x1) => { x0.volume = x1 },
      _13279: (x0,x1) => { x0.onstart = x1 },
      _13280: (x0,x1) => { x0.onend = x1 },
      _13281: (x0,x1) => { x0.onpause = x1 },
      _13282: (x0,x1) => { x0.onresume = x1 },
      _13283: (x0,x1) => { x0.onerror = x1 },
      _13284: (x0,x1) => { x0.onboundary = x1 },
      _13286: x0 => x0.lang,
      _13287: x0 => x0.localService,
      _13288: x0 => x0.name,
