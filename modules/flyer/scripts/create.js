class Flyer {
  constructor() {
    ...
    this.crop_image = "";
    this.link =
      "https://gregarious-shortbread-ebb235.netlify.app/modules/flyer/flyer.html";
  }
}

class Create {
  static flyer = new Flyer();
  static product_image_import_input = document.querySelector(
    "#product_image_import_input",
  );
  static previewImageArea = document.querySelector("#previewImageArea");
  static caracteristiques_container = document.querySelector(
  ...
  static render_caracteristique() {
    ...
    let lastInput = document.querySelector(
      "#caracteristiques_container .formItem:last-child input",
    );
    lastInput.focus();
  }
